...
public class SchemeAdapter extends FirebaseRecyclerAdapter<Schemes, SchemeAdapter.myViewholder> {
    /**
    ...
    public SchemeAdapter(@NonNull FirebaseRecyclerOptions<Schemes> options) {
        super(options);
    }
    ...
    public myViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.schemesmodel,parent,false);
